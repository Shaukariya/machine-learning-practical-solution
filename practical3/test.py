...
def reshape_data(X, y, is_image: bool= False):
    N = X.shape[0]
...
'''
    ...
    x_train, y_train = reshape_data(x_train, y_train, is_image=True)
    x_test, y_test = reshape_data(x_test, y_test, is_image=True)
